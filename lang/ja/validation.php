...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'tolerances.yuki_length-long_or_short.min_value' => '裄丈（大きく合わない）の下限値',
        'tolerances.yuki_length-long_or_short.max_value' => '裄丈（大きく合わない）の上限値',
        ...
        'tolerances.neck_circumference-long_or_short.min_value' => '首回り（大きく合わない）の下限値',
        'tolerances.neck_circumference-long_or_short.max_value' => '首回り（大きく合わない）の上限値',
        ...
        'tolerances.chest_circumference-long_or_short.min_value' => '胸囲（大きく合わない）の下限値',
        'tolerances.chest_circumference-long_or_short.max_value' => '胸囲（大きく合わない）の上限値',
        ...
        'tolerances.waist-long_or_short.min_value' => 'ウエスト（大きく合わない）の下限値',
        'tolerances.waist-long_or_short.max_value' => 'ウエスト（大きく合わない）の上限値',
        ...
        'tolerances.inseam-long_or_short.min_value' => '股下（大きく合わない）の下限値',
        'tolerances.inseam-long_or_short.max_value' => '股下（大きく合わない）の上限値',
        ...
        'tolerances.hip-long_or_short.min_value' => 'ヒップ（大きく合わない）の下限値',
        'tolerances.hip-long_or_short.max_value' => 'ヒップ（大きく合わない）の上限値',
    ],
];
