<div class="w-1/2 sm:w-1/3 md:w-1/4 p-2">
  <div class="bg-gray-100 rounded-lg overflow-hidden shadow hover:shadow-lg transition-shadow duration-200">
    <div class="w-full h-52 overflow-hidden cursor-pointer"
