            ...
            <div class="w-full sm:w-1/3 text-center">
              ...
              <div class="w-2/3 mx-auto mt-3">
                <img id="preview-main" class="rounded shadow w-full object-cover"
                  src="{{ Storage::disk('s3')->temporaryUrl('items/' . $coordinate->items[0]->image->file_name, now()->addMinutes(10)) }}">
            ...
            <div class="w-full sm:w-1/3 text-center">
              ...
              <div class="w-2/3 mx-auto mt-3">
                <img id="preview-sub1" class="rounded shadow w-full object-cover"
                  src="{{ Storage::disk('s3')->temporaryUrl('items/' . $coordinate->items[1]->image->file_name, now()->addMinutes(10)) }}">
              ...
              <div class="w-2/3 mx-auto mt-3">
                @if (isset($coordinate->items[2]))
                  <img id="preview-sub2" class="rounded shadow w-full object-cover"
                    src="{{ Storage::disk('s3')->temporaryUrl('items/' . $coordinate->items[2]->image->file_name, now()->addMinutes(10)) }}">
